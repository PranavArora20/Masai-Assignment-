...
// Problem Statement: Design a system that determines access privileges for a platform based on a user's role, experience (in years), 
// active status (active or inactive), and department. The program should provide access levels that vary according to a combination of these factors.
...
function PrivilegeManagementSystem(obj){
    return obj["role"]=="admin" ? obj["active"] ? obj["experience"]>5 ? obj["department"]=="IT" ? "Full IT Admin Access" 
            : "Full General Admin Access" : 
            "Limited Admin Access" : 
            "Admin Access Revoked" :
            obj["role"] == "manager" ? obj["active"] ? obj["experience"]>3 ? obj["department"]=="Sales" ? "Full Sales Manager Access" : 
            "Full Manager Access" : 
            "Limited Manager Access" :
            "Manager Access Revoked" : 
            obj["role"] == "user" ? obj["active"] ? obj["department"]=="Support" ? "Priority Support Access" :
            "User Access" :
            "User Access Revoked" :
            "Invalid Role"
...
console.log(PrivilegeManagementSystem(person1))
console.log(PrivilegeManagementSystem(person2))
console.log(PrivilegeManagementSystem(person3))
console.log(PrivilegeManagementSystem(person4))
